    ...
    >
      <div class="bg-white rounded-2xl max-w-2xl w-full p-6 shadow-xl overflow-y-auto max-h-[90vh]">
        <div class="flex justify-between items-center mb-4">
          ...
          <button @click="close" class="text-gray-500 hover:text-black">&times;</button>
        </div>
        <div class="space-y-6 text-gray-800 text-sm">
          <p><strong>Last updated:</strong> May 20, 2025</p>
  
          <div>
            <p>This website collects personal data when you submit the contact form. This policy explains what data we collect, why, and how we handle it.</p>
          </div>
          ...
          <div>
            ...
            <p>Your data is retained for up to 90 days unless you request deletion sooner.</p>
          </div>
          ...
          <div>
            ...
            <p>For questions or data requests, contact: <strong>your@email.com</strong></p>
          </div>
        </div>
      </div>
    </div>
